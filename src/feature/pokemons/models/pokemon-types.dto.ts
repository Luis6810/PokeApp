// To parse this data:
//
//   import { Convert, TypesDTO } from "./file";
//
//   const typesDTO = Convert.toTypesDTO(json);
...
export interface GenerationViii {
    "brilliant-diamond-shining-pearl": Colosseum;
...
export class Convert {
    public static toPokemonTypesDTO(json: string): PokemonTypesDTO {
        return JSON.parse(json);
    }

    public static pokemonTypesDTOToJson(value: PokemonTypesDTO): string {
